...
from tasks.views import manager_deshboard, employee_deshboard, test, create_task,view_task,update_task, task_details, dashboard, CreateTask, ViewProject, TaskDetail,DeleteTask, UpdateTask, ManagerDashboard
urlpatterns =[
